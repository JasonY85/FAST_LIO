...
This is a modified version of FAST_LIO to work with livox_ros_driver2 for Livox Mid-360
...
ROS    >= Melodic (Recommend to use ROS-Noetic). [ROS Installation](https://wiki.ros.org/noetic/Installation/Ubuntu)
